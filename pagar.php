...
$listArticulos = new ItemList();
$listArticulos->setItems(array($arreglo_pedido));
...
$transaccion->setAmount($precio)
        ->setItemList($listArticulos)
        ->setDescription('Pago GLDWEBCAMP')
        ->setInvoiceNumber(uniqid($ID_registro));
...
} catch (PayPal\Exception\PayPalConecctionException $pce) {
    echo "<pre>";
